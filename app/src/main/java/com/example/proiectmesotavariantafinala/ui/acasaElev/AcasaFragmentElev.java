...
public class AcasaFragmentElev extends Fragment {
    TextView mEmail;
    ...
    private AcasaModelElev homeViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        homeViewModel =
                ViewModelProviders.of(this).get(AcasaModelElev.class);

        View root = inflater.inflate(R.layout.fragment_elev_acasa, container, false);
